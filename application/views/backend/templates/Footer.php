<footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Tripmen 2023</div>
                            <div>
        ...
        <script src="<?= base_url('vendor') ?>/assets/demo/chart-area-demo.js"></script>
        <script src="<?= base_url('vendor') ?>/assets/demo/chart-bar-demo.js"></script>
